...
class State:
    ...
    __vars = OrderedDict() # dictionary of name->view for GraphLab data structures discovered from stack frames
    __var_ids = {} # dictionary of id (long)->name (tuple) and name->id for GraphLab data structures in Canvas (two way map)
