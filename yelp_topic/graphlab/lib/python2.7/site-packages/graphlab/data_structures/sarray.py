...
class SArray(object):
    ...
    def __str__(self):
        ...
        if self.dtype() == graphlab.data_structures.image.Image:
    ...
    def pixel_array_to_image(self, width, height, channels, undefined_on_failure=True, allow_rounding=False):
        ...
        >>> mnist_array = graphlab.SArray('http://s3.amazonaws.com/GraphLab-Datasets/mnist/mnist_vec_sarray')
    ...
    def astype(self, dtype, undefined_on_failure=False):
        ...
        if (dtype == graphlab.Image) and (self.dtype() == array.array):
    ...
    def show(self, view=None):
        """
        show(view=None)
        Visualize the SArray with GraphLab :mod:`~graphlab.canvas`. This function starts Canvas
