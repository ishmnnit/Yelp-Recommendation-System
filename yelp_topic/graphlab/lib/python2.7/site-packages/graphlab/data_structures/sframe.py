    ...
    if sprk_ctx.master == 'yarn-client':
        ...
        if STAGING_DIR is None:
            raise RuntimeError("Could not retrieve local staging directory! \
                    Please contact us on http://forum.graphlab.com.")
...
class SFrame(object):
    ...
    * HTTP(S).
    ...
    and examples, please see the `User Guide <http://www.graphlab.com/learn/user
    guide.html#Working_with_data_Tabular_data>`_, `API Translator
    <http://www.graphlab.com/learn/translator>`_, `How-Tos
    <http://www.graphlab.com/learn/how-to>`_, and data science `Gallery
    <http://www.graphlab.com/learn/gallery>`_.
    ...
    def from_rdd(cls, rdd):
        """
        Convert a Spark RDD into a GraphLab SFrame.
    ...
    def show(self, columns=None, view=None, x=None, y=None):
        ...
        Visualize the SFrame with GraphLab :mod:`~graphlab.canvas`. This function starts Canvas
        if it is not already running. If the SFrame has already been plotted,
