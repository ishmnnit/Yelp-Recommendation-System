...
DEFAULT_HYPER_PARAMETER_RANGE = {
    ...
    'ranking_regularization': [0.001, 0.01, 0.1, 0.25, 0.5, 1],
    'regularization' : [0, 1e-7, 1e-5, 1e-3]
}
...
def create(observation_data,
    ...
    unobserved_rating_value : float, optional
        Penalize unobserved
        items with a larger predicted score than this value. By default, the
        estimated 5% quantile is used (mean - 1.96*std_dev).
    ...
    solver : string, optional
        ...
        - *ials*: Implicit matrix factorization [1]
    ...
    **Using the implicit matrix factorization model**

    Ranking factorization also implements implicit matrix factorization [1] as
